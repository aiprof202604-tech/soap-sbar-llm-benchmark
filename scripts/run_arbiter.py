...
ARBITER_MODEL = "claude-haiku-4-5-20251001"  # match generation snapshot
...
def main():
    ...
    ap.add_argument("--out-arbiter", default=str(DATA / "stage3_arbiter.csv"))
    ap.add_argument("--out-final", default=str(DATA / "final_scores.csv"))
    ...
    if pending:
        ...
        print(f"Querying Claude Opus arbiter on {len(pending)} cells "
